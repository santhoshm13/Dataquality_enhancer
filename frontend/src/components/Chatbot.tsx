    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-12 h-12 rounded-xl bg-white/10 hover:bg-white/20 text-white border border-white/20 shadow-lg flex items-center justify-center z-50 transition-all cursor-pointer"
